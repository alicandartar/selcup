...
class Sustainability extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['sustainabilities']   = $this->Sustainability_model->GetAll();
        ...
        $data['pageslider']         = $this->Menu_model->getPageSlider("sustainability");
        $data['info']               = $this->Menu_model->getMenuName("sustainability");
        $seo = $this->Menu_model->seo();;
        $seo = json_decode($seo->content);
        $data['seo'] = $seo->page; 
        $this->load->view("front/sustainability_view", $data);
    }
