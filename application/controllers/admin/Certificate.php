...
class Certificate extends CI_Controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->model('admin/certificate_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('certificate/index_view');
        $this->data['certificates'] = $this->model->ListContent();
    ...
    public function add()
    {
        ...
        $viewpage = array('certificate/add_view');

        $this->form_validation->set_rules('sequence', 'Sırası', 'required');
    ...
    public function edit($id)
    {
        ...
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('certificate/edit_view');
