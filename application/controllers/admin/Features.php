...
class Features extends CI_Controller {
    ...
    function __construct(){
        ...
        parent::__construct();
        $this->load->model('admin/features_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('features/index_view');
        $this->data['PageUrl'] = $this->my_url->CurrentUrl();
        $this->data['features'] = $this->model->ListContent();
    ...
    public function add(){
        ...
        $viewpage = array('features/add_view');
    ...
    public function edit($id){
        ...
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('features/edit_view');
