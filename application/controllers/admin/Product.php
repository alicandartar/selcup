...
class Product extends CI_Controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->model('admin/product_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('product/index_view');
        $this->data['cups'] = $this->model->ListContent();
        $this->data['products'] = $this->model->ListContentProduct();
    ...
    public function add()
    {
        ...
        $this->data['products'] = $this->model->ListContentProduct();
        $viewpage = array('product/add_view');

        $this->form_validation->set_rules('size', 'Bardak Boyut', 'required');
    ...
    public function edit($id)
    {
        ...
        $this->data['products'] = $this->model->ListContentProduct();
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('product/edit_view');
