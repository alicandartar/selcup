...
class Cupstatics extends CI_Controller {

    function __construct(){

        parent::__construct();
        $this->load->model('admin/cupstatics_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('cupstatics/index_view');
        $this->data['PageUrl'] = $this->my_url->CurrentUrl();
        $this->data['cupstatics'] = $this->model->ListContent();
        $this->data['cupsname'] = $this->model->ListCupsName();
    ...
    public function add(){
        ...
        $this->data['cupsname'] = $this->model->ListCupsName();
        $viewpage = array('cupstatics/add_view');

        $this->form_validation->set_rules('cupname', 'cupname', 'required');
    ...
    public function edit($id){
        ...
        $this->data['cupsname'] = $this->model->ListCupsName();
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('cupstatics/edit_view');

        $this->form_validation->set_rules('cupname', 'title', 'required');
        $this->form_validation->set_rules('content', 'content', 'required');
