...
class Otherslider extends CI_Controller {

    function __construct(){

        parent::__construct();
        $this->load->model('admin/otherslider_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('otherslider/index_view');
        $this->data['PageUrl'] = $this->my_url->CurrentUrl();
        $this->data['othersliders'] = $this->model->ListContent();
    ...
    public function add(){
        ...
        $this->data['menus'] = $this->model->getMenus(1);
        $this->data['submenus'] = $this->model->getSubMenus();
        $viewpage = array('otherslider/add_view');
    ...
    public function edit($id){
        ...
        $this->data['submenus'] = $this->model->getSubMenus();
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('otherslider/edit_view');
