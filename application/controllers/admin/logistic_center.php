...
class logistic_center extends CI_Controller {

    function __construct()
    {

        parent::__construct();
        $this->load->model('admin/logisticcenter_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('logistic_centers/index_view');
    ...
    public function add()
    {
        ...
        $viewpage = array('logistic_centers/add_view');

        $this->form_validation->set_rules('title', 'Ülke Adı', 'required');
    ...
    public function edit($id)
    {
        ...
        $viewpage = array('logistic_centers/edit_view');
    ...
    public function clone_section($id)
    {

        $this->data['CurrentUrl'] = $this->my_url->CurrentUrl();
        $this->data['link'] = $this->page_model->get_link();
        $this->data['info'] = $this->model->FindContent($id);
        $viewpage = array('logistic_centers/clone_view');

        $this->form_validation->set_rules('title', 'Haber Başlığı', 'required');
