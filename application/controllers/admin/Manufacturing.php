...
class Manufacturing extends CI_Controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->model('admin/manufacturing_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('manufacturing/index_view');
        $this->data['manufacturings'] = $this->model->ListContent();
    ...
    public function edit($id)
    {
        ...
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('manufacturing/edit_view');
