...
class Page extends CI_Controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->model('admin/Page_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('page/index_view');
    ...
    public function add()
    {
        ...
        $this->data['menus'] = $this->model->getMenuName();
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('page/add_view');
