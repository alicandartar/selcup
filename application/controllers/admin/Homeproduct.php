...
class Homeproduct extends CI_Controller {

    function __construct()
    {

        parent::__construct();
        $this->load->model('admin/homeproduct_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('homeproduct/index_view');
        $this->data['homeproducts'] = $this->model->ListContent();
    ...
    public function add()
    {
        ...
        $viewpage = array('manufacturing/add_view');
    ...
    public function edit($id)
    {
        ...
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('homeproduct/edit_view');
