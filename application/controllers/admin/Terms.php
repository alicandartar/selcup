...
class Terms extends CI_Controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->model('admin/terms_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('settings/terms/index_view');
        $this->data['PageUrl'] = $this->my_url->CurrentUrl();
        $this->data['terms'] = $this->model->ListContent();
   ...
   /* public function add()
    ...
    public function edit($id)
    {
        ...
        $viewpage = array('settings/terms/edit_view');
        if(!$_POST){
