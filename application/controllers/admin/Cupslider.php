...
class Cupslider extends CI_Controller {

    function __construct(){

        parent::__construct();
        $this->load->model('admin/cupslider_model','model',TRUE);
    ...
    public function index()
    {
        ...
        $viewpage = array('cupslider/index_view');
        $this->data['PageUrl'] = $this->my_url->CurrentUrl();
        $this->data['cupsliders'] = $this->model->ListContent();
    ...
    public function add(){
        ...
        $viewpage = array('cupslider/add_view');
    ...
    public function edit($id){
        ...
        $this->data['submenus'] = $this->model->getSubMenus();
        //$this->data['link'] = $this->page_model->get_link();
        $viewpage = array('cupslider/edit_view');
