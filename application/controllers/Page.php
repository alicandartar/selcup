...
class Page extends CI_Controller {
    ...
    public function index($slug)
    {
        ...
        $data['contents']         = $this->Page_model->GetAllPageContent($slug);
        ...
        $data['pageslider']      = $this->Menu_model->getPageSlider('page/'.$slug);
        $data['info']            = $this->Menu_model->getPageMenuName($slug);
