		...
		<div class="wrap">
			...
			<section>
				...
				<div class="page-title">
					...
					<div class="bg" style="background-image:url(<?=base_url()?><?=$pageslider[0]->image?>)"></div><!--Burası düzeltilecek foto index old için gözükmüyor.-->
						...
						<div class="list">
							<?php foreach ($news as $new) {?>
								<?php echo '<div class="item">'; ?>
									<?php echo '<a href="'.base_url().'news/'.$new->slug.'">'; ?>
										<?php echo '<div class="photo"><img src="'.base_url().$new->image.'"></div>'; ?>
										<?php echo '<div class="info">'; ?>
											<?php echo '<div class="date"><span>'.date("d/m/Y",$new->date).'</span></div>'; ?>
											<?php echo '<div class="name">'.$new->title.'</div>'; ?>
										<?php echo '</div>'; ?>
									<?php echo '</a>'; ?>
								<?php echo '</div>'; ?>
								<?php }?>
