		...
		<div class="wrap">
			...
			<section>
				...
				<div class="page-title">
					...
					<div class="container">
						<h1><?php echo $cupsname[2]->name;?></h1>
					</div>
				</div>
				...
				<div class="product-detail bio-product-detail">
					...
					<div class="content">
						...
						<div class="product-tab">
							<div class="product-tab-left">
								...
								<div class="tab-menu">
									<?php foreach($cupssize as $cupsize) { if ($cupsize->cup_name_id == '3') {?>
										<?php echo "<a href='#productSize".$cupsize->id."'>"; ?>
											<?php echo "<div class='item'>"; ?>
												<?php echo "<div class='photo'><img src='".base_url()."".$cupsname[2]->image."' height='60'></div>";?>
									...
									<?php echo '<div id="productSize'.$cupsize->id.'" class="tab-content">';?>
										<?php echo '<div class="product-inner">';?>
											<?php echo '<div class="product-gallery">';?>
												<h2><?php echo $cupsname[2]->name;?></h2>
												<?php echo '<div class="slider">';?>
													<?php echo '<div class="item"><img src="'.base_url().''.$cupsname[2]->image.'"></div>';?>
													<!--<?php echo '<div class="item"><img src="'.base_url().''.$cupsname[2]->image.'"></div>';?>-->
												<?php echo '</div>';?>
											<?php echo '</div>';?>
				...
				<div class="product-concept-info">
					<div class="content">
						...
						<div class="product-concept-info-left">
							<h3><?php echo $cupsname[2]->name;?></h3>
