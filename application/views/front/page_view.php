		...
		<div class="wrap">
							...
							<?php if ($menu->is_submenu == 1) { ?>
								...
								<?php } else { ?>
									<?php if($menu->slug == "sustainability") {echo "<li class='sustainability'><a href='".base_url().$menu->slug."'>$menu->menu_name</a></li>";} else {?>
										<?php if('page/'.$this->uri->segment(2) == $menu->slug){ echo "<li><a class='active' href='".base_url().$menu->slug."'>$menu->menu_name</a></li>";?>
			...
			<section>
				...
				<div class="page-title">
					...
					<div class="container">
							<?php foreach($menus as $menu){ if($menu->slug == 'page/'.$this->uri->segment(2)) {?>
