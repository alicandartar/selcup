		...
		<div class="wrap">
					...
					<ul>
						<?php foreach ($menus as $menu) { ?>
							<?php if ($menu->is_submenu == 1) { ?>
								<?php if($this->uri->segment(1) == 'product'){ echo "<li><a class='active' href='".$menu->slug."'>$menu->menu_name<i class='fas fa-chevron-down'></i></a>";?>
			...
			<section>
				...
				<div class="page-title">
					...
					<div class="bg" style="background-image:url(<?php foreach($pagesliders as $pageslider){if($pageslider->pagename == $this->uri->segment(2)){echo base_url().$pageslider->image;}}?>)"></div>
					<div class="down" onclick="scrollSection($('.content-start'), 80)"></div>
					<div class="container">
						<h1><?php foreach($cupsname as $cupname){ if($cupname->slug == $this->uri->segment(2)) echo $cupname->name;}?></h1>
					</div>
				</div>
					...
					<div class="content">
						<div class="product-menu">
							<div class="container">
								<ul>
									...
									<?php echo "<li><a href='".base_url()."product/$cupname->slug' class='active'>$cupname->name</a></li>"; ?>
									<?php }else echo "<li><a href='".base_url()."product/$cupname->slug'>$cupname->name</a></li>";} ?>
								</ul>
							</div>
						</div>
						<div class="product-tab">
							<div class="product-tab-left">
								...
								<div class="tab-menu">
									<?php foreach($cupssize as $cupsize) { if ($cupsize->cup_name_id == $cupid[0]->id) {?>
										<?php echo "<a href='#productSize".$cupsize->id."'>"; ?>
											<?php echo "<div class='item'>"; ?>
												...
												<?php foreach($cupsname as $cupname){if($cupname->id == $cupid[0]->id){ echo '<div class="photo"><img src="'.base_url().''.$cupname->image.'" height="60"></div>';}}?>
									...
									<?php echo '<div id="productSize'.$cupsize->id.'" class="tab-content">';?>
										<?php echo '<div class="product-inner">';?>
											<?php echo '<div class="product-gallery">';?>
												<h2><?php foreach($cupsname as $cupname){if($cupname->id == $cupid[0]->id){echo $cupname->name;}}?></h2>
												<?php echo '<div class="slider">';?>
													<?php foreach($cupsname as $cupname){if($cupname->id == $cupid[0]->id){ echo '<div class="item"><img src="'.base_url().''.$cupname->image.'"></div>';}}?>
