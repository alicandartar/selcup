...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/mainproduct/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/mainproduct/add">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>Ürün İsmi</th>
                                <th>Ürün Resim</th>
                                <th>Ürün Anasayfa Açıklama Bölümü</th>
                                <th>İşlemler</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($products as $key => $product){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$product->id?>" name="ID[]"> </td>
                                    <td><?=$product->name?></td>
                                    <td><img src="<?=base_url().$product->image?>" width="70"> </td>
                                    <td><?=$product->shortdetail?></td>
                                    <td><a href="<?=base_url()?>admin/mainproduct/edit/<?=$product->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
