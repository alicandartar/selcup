            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ana Ürün Bölümü Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="name">Bardak İsmi</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Başlık" value="<?=$info->name?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="content">Ürün Anasayfa Açıklama Bölümü</label>
                            <textarea name="content" id="content" class="form-control" rows="20"><?=$info->shortdetail?></textarea>
                        </div>
                        <!--<div class="form-group">
