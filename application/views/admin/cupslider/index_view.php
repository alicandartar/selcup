...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/cupslider/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/cupslider">
                    <span class="badge bg-teal"><?=$TotalPage?></span>
                    <i class="fa fa-tags"></i>Diğer Sayfa Slider
                </a>
            </small>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/cupslider/add">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach($cupsliders as $key => $cupslider){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$cupslider->id?>" name="ID[]"> </td>
                                    <td><?=$cupslider->slug?></td>
                                    <td><img src="<?=base_url().$cupslider->image?>" width="100"> </td>
                                    <td><a href="<?=base_url()?>admin/cupslider/edit/<?=$cupslider->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
