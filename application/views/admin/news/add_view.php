            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <a href="<?=base_url()?>filemanager/dialog.php?type=0&field_id=cover0&relative_url=1&akey=<?=$this->config->item('encryption_key')?>" class="iframe-btn">
                                    <img id="cover0View" src="http://placehold.it/800x344" class="img-responsive CoverView">
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="published">Tarih</label>
                            <input type="text" name="published" id="published" class="form-control datetimepicker" value="<?=date('d-m-Y',strtotime('now'))?>">
                        </div>
                        <div class="form-group">
