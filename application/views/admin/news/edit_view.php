                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" class="form-control" rows="20"><?=$info->detail?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="published">Tarihi</label>
                            <input type="text" name="published" id="published" class="form-control datetimepicker" value="<?=date('d/m/Y',$info->date)?>">
                        </div>
                        <div class="form-group">
