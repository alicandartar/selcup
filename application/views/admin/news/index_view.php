...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/news/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/news/add">
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($Contents as $key => $Content){?>
                                <tr>
                                    ...
                                    <td><?=$Content->title?></td>
                                    <td><img src="<?=base_url().$Content->image?>" width="100"> </td>
                                    <td><a href="<?=base_url()?>admin/news/edit/<?=$Content->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
