            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Hakkımızda Bölümü Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title">Başlık</label>
                            <input type="text" name="title" class="form-control" id="title" placeholder="Başlık" value="<?=$info->title?>" required>
                        </div>
                        <div class="form-group">
                            <label for="details">Açıklama</label>
                            <textarea name="details" id="details" class="form-control" rows="20"><?=$info->details?></textarea>
                        </div>
                        <?php if ($info->shortdetail != '') {?>
                        <?php echo '<div class="form-group">';?>
                        <?php echo '<label for="shortdetail">Anasayfa Görünür Açıklama(Sadece Hakkımızda kısmı içindir.)</label>';?>
                        <?php echo '<textarea name="shortdetail" id="shortdetail" class="form-control" rows="20">'.$info->shortdetail.'</textarea>';?>
                        <?php echo '</div>';?>
                        <?php } ?>
                        <!--<div class="form-group">
