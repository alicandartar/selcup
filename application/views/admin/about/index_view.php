...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/about/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>-->
                <a class="btn btn-app" href="<?=base_url()?>admin/about/add">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($abouts as $key => $about){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$about->id?>" name="ID[]"> </td>
                                    <td><?=$about->title?></td>
                                    <td><?=$about->details?></td>
                                    <td><a href="<?=base_url()?>admin/about/edit/<?=$about->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
