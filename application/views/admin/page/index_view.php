...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/page/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>-->
                <a class="btn btn-app" href="<?=base_url()?>admin/page/add">
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($contents as $key => $content){?>
                                <tr>
                                    ...
                                    <td><a href="<?=base_url()?>admin/page/edit/<?=$content->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
