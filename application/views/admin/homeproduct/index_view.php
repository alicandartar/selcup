...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/homeproduct/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach($homeproducts as $key => $homeproduct){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$homeproduct->id?>" name="ID[]"> </td>
                                    <td><?=$homeproduct->size?></td>
                                    <td><img src="<?=base_url().$homeproduct->image?>" width="100"> </td>
                                    <td><a href="<?=base_url()?>admin/homeproduct/edit/<?=$homeproduct->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
