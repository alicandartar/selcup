...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/certificate/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/certificate/add">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($certificates as $key => $certificate){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$certificate->id?>" name="ID[]"> </td>
                                    <td><img src="<?=base_url().$certificate->image?>" width="100"> </td>
                                    <td><?=$certificate->image_state?></td>
                                    <td><a href="<?=base_url()?>admin/certificate/edit/<?=$certificate->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
