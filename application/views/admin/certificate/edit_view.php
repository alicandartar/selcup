            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sertifika Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="sequence">Sırası</label>
                            <input type="text" name="sequence" class="form-control" id="sequence" placeholder="Sırası" value="<?=$info->image_state?>" required>
                        </div>
                    </div><!-- /.box-body -->
