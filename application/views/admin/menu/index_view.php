...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/menu/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/menu">
                    <span class="badge bg-teal"><?=$TotalPage?></span>
                    <i class="fa fa-tags"></i> İçerikler
                </a>
            </small>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/menu/add">
                    <i class="fa fa-plus"></i> Menu Ekle
                </a>
            </small>
            <small>
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($menus as $key => $menu): ?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$menu->id?>" name="ID[]"> </td>
                                    <td><?=$menu->menu_name?></td>
                                    <td><a href="<?=base_url()?>admin/menu/edit/<?=$menu->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                            <tfoot>
