            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Menu Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="name">Menu İsmi</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Menu İsmi" value="<?=$info->menu_name?>" required>
                        </div>
                        <div class="form-group">
                            <label for="squence">Menu Sırası</label>
                            <input type="text" name="squence" class="form-control" id="squence" placeholder="Menu İsmi" value="<?=$info->menu_state?>" required>
                        </div>
                    </div><!-- /.box-body -->
