            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Menu Ekleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="name">Menu Adı</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Menu Adı" required>
                        </div>
                        <div class="form-group">
                            <label for="squence">Menu Sırası</label>
                            <input type="text" name="squence" class="form-control" id="squence" placeholder="Sırası" required>
                        </div>
                    </div><!-- /.box-body -->
