            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ürün Kataloğu Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title">İsim İlk Parca</label>
                            <input type="text" name="product" class="form-control" id="product" placeholder="Sayfada Görünür İsmi" value="<?=$info->product?>" required>
                        </div>
                        <div class="form-group">
                            <label for="title">İsim İkinci Parca</label>
                            <input type="text" name="catalog" class="form-control" id="catalog" placeholder="Sayfada Görünür İsmi" value="<?=$info->catalog?>" required>
                        </div>
                        <div class="form-group">
                            <label>Sayfa Dosya Seç</label>
                            <div class="input-group">
                                ...
                                <a href="<?=base_url()?>filemanager/dialog.php?type=0&field_id=cover0&relative_url=1&akey=<?=$this->config->item('encryption_key')?>" class="iframe-btn">
                                    ...
                                    <embed src="<?=base_url()?><?=$info->image?>" width="800px" height="750px" />
                                </a>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
