...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/catalog/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/catalog">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Sistemde Bulunan Şartlar ve Politikalar Metinleri</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($catalogs as $key => $catalog): ?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$catalog->id?>" name="ID[]"> </td>
                                    <td><?=$catalog->product?></td>
                                    <td><?=$catalog->catalog?></td>
                                    <td><embed src="<?=base_url()?><?=$catalog->image?>" width="800px" height="400px" /></td>
                                    <td><a href="<?=base_url()?>admin/catalog/edit/<?=$catalog->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                            <tfoot>
