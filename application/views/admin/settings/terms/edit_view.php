...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Şartlar ve Politikalar Ayarları
            <small></small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Şartlar ve Politikalar Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title">Sayfada Görünür İsmi</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Sayfada Görünür İsmi" value="<?=$info->name?>" required>
                        </div>
