...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/terms/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/terms">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($terms as $key => $term): ?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$term->id?>" name="ID[]"> </td>
                                    <td><?=$term->name?></td>
                                    <td><?=$term->content?></td>
                                    <td><a href="<?=base_url()?>admin/terms/edit/<?=$term->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                            <tfoot>
