...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/otherslider/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/otherslider">
                    <span class="badge bg-teal"><?=$TotalPage?></span>
                    <i class="fa fa-tags"></i>Diğer Sayfa Slider
                </a>
            </small>
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/otherslider/add">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tr>
                                <th>Çoklu Seçim</th>
                                <th>Hangi Sayfaya Ait</th>
                                <th>Resim</th>
                                <th>İşlemler</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($othersliders as $key => $otherslider){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$otherslider->id?>" name="ID[]"> </td>
                                    <td><?=$otherslider->pagename?></td>
                                    <td><img src="<?=base_url().$otherslider->image?>" width="100"> </td>
                                    <td><a href="<?=base_url()?>admin/otherslider/edit/<?=$otherslider->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
