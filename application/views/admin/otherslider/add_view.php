                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <a href="<?=base_url()?>filemanager/dialog.php?type=0&field_id=cover0&relative_url=1&akey=<?=$this->config->item('encryption_key')?>" class="iframe-btn">
                                    <img id="cover0View" src="http://placehold.it/800x640" class="img-responsive CoverView">
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="pagename" id="pagename" class="form-control">
                                ...
                                <?php foreach ($submenus as $submenu) {?>
                                    <option value=<?=$submenu->slug?> > <?=$submenu->sub_menu_name?></option>
                                <?php }?>
                                <option value="newsdetail"> News Detail</option>
                            </select>
                        </div>
                    </div><!-- /.box-body -->
