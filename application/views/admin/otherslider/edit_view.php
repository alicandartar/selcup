            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sldier Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="pagename">Hangi Sayfada Gösterilecek</label>
                            <select name="pagename" id="pagename" class="form-control">
                                <?php foreach ($menus as $menu) {?>
                                    <option value=<?=$menu->slug?> <?=$info->pagename == $menu->slug ? 'Selected': NULL?> > <?=$menu->menu_name?></option>
                                <?php }?>
                                <?php foreach ($submenus as $submenu) {?>
                                    <option value=<?=$submenu->slug?> <?=$info->pagename == $submenu->slug ? 'Selected': NULL?> > <?=$submenu->sub_menu_name?></option>
                                <?php }?>
                                <option value="newsdetail" <?=$info->pagename == 'newsdetail' ? 'Selected': NULL?> > News Detail</option>
                            </select>
                        </div>
                    </div><!-- /.box-body -->
