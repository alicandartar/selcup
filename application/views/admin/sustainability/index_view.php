...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/sustainability/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/sustainability/add">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach($statics as $key => $static){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$static->id?>" name="ID[]"> </td>
                                    <td><img src="<?=base_url().$static->image?>" width="100"> </td>
                                    <td><?=$static->statement?></td>
                                    <td><a href="<?=base_url()?>admin/sustainability/edit/<?=$static->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
