...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Ürün Özellikler Kısmı(Features)
            <small></small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ürün Özellikler(Features) Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title">Hangi Ana Ürüne Ait</label>
                            <select name="cupname" id="cupname" class="form-control">
                            <?php foreach ($cupsname as $cupname) {?>
                                <option value=<?=$cupname->id?> <?=$info->cups_name_id == $cupname->id ? 'Selected': NULL?> > <?=$cupname->name?></option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="content">İçerik</label>
                            <textarea name="content" id="content" class="form-control" rows="20"><?=$info->statement?></textarea>
                        </div>
                    </div><!-- /.box-body -->
