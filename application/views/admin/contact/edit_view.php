            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">İletişim Bilgileri Düzenleme Formu</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            <label for="address">Adres</label>
                            <input type="text" name="address" class="form-control" id="address" placeholder="Başlık" value="<?=$info->address?>" required>
                        </div>
                        <div class="form-group">
                            <label for="hidden">Sol Açılan Menu Adres</label>
                            <input type="text" name="hidden" class="form-control" id="hidden" placeholder="hidden adres" value="<?=$info->hidden_address?>" required>
                        </div>
                        <div class="form-group">
                            <label for="mobile">Cep Telefonu</label>
                            <input type="text" name="mobile" class="form-control" id="mobile" placeholder="mobile" value="<?=$info->mobile?>" required>
                        </div>
                        <div class="form-group">
                            <label for="phone">Telefon</label>
                            <input type="text" name="phone" class="form-control" id="phone" placeholder="Height" value="<?=$info->phone?>" required>
                        </div>
                        <div class="form-group">
                            <label for="fax">Fax</label>
                            <input type="text" name="fax" class="form-control" id="fax" placeholder="fax" value="<?=$info->fax?>" required>
                        </div>
                        <div class="form-group">
