...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/contact/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/contact/add">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($contacts as $key => $contact){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$contact->id?>" name="ID[]"> </td>
                                    <td><?=$contact->address?></td>
                                    <td><?=$contact->mobile?></td>
                                    <td><?=$contact->email?></td>
                                    <td><a href="<?=base_url()?>admin/contact/edit/<?=$contact->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
