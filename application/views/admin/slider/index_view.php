...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/slider/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <?php foreach($Contents as $key => $Content){?>
                                <tr>
                                    ...
                                    <td><a href="<?=base_url()?>admin/slider/edit/<?=$Content->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
