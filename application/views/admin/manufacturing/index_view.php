...
<script type="text/javascript" charset="utf-8">
    $( document ).ready(function() {
        ...
        $("#ListDelete").on("click",function(){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>admin/manufacturing/ListDelete",
                type: "post",
                data: data,
                dataType: "text",
                cache: false,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>
                <a class="btn btn-app" href="<?=base_url()?>admin/manufacturing/add">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach($manufacturings as $key => $manufacturing){?>
                                <tr>
                                    <td><input type="checkbox" id="ID" class="ID" value="<?=$manufacturing->id?>" name="ID[]"> </td>
                                    <td><?=$manufacturing->title?></td>
                                    <td><img src="<?=base_url().$manufacturing->image?>" width="100"> </td>
                                    <td><a href="<?=base_url()?>admin/manufacturing/edit/<?=$manufacturing->id?>" class="btn btn-warning">Düzenle</a></td>
                                </tr>
                            <?php }?>
                            </tbody>
                            <tfoot>
